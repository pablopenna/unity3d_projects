//Example taken from https://docs.unity3d.com/ScriptReference/Transform-position.html
...
public class TransformDocExample : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // Faster
        //increaseXZPosition = (2.0f * Mathf.PI);

        // Random speed up/down.
        increaseYPosition = (2.0f * Mathf.PI) / 1.3f;
        // Faster
        //increaseYPosition = (2.0f * Mathf.PI);
    ...
    void Update()
    {
        ...
        // Smaller rotation radius
        spherePosition = new Vector3(Mathf.Sin(xzPosition), 4.0f * Mathf.Sin(yPosition), Mathf.Cos(xzPosition));
        transform.position = spherePosition;

        // Remember that a complete circunference is 2Pi.
